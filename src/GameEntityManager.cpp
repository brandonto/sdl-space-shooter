...
std::vector<GameEntity*> GameEntityManager::createMainMenu(WindowElements* windowElements)
{
    ...
    //printf("x = %d", temp.x);
    //printf("y = %d", temp.y);
    uiTitleRender->addText("Space", 24, &temp, true);
    temp.x = 5;
    temp.y = 45;
    temp.w = 94;
    temp.h = 70;
    uiTitleRender->addText("Shooter", 24, &temp, true);
    ...
    temp.w = 80;
    temp.h = 60;
    uiPlayRender->addText("Play", 24, &temp, true);
    ...
    temp.w = 80;
    temp.h = 60;
    uiInstructionsRender->addText("Instructions", 24, &temp, true);
    ...
    temp.w = 80;
    temp.h = 60;
    uiOptionsRender->addText("Options", 24, &temp, true);
    ...
    temp.w = 80;
    temp.h = 60;
    uiCreditsRender->addText("Credits", 24, &temp, true);
    ...
    temp.w = 80;
    temp.h = 60;
    uiQuitRender->addText("Quit", 24, &temp, true);
